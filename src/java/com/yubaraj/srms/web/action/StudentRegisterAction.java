 ...
 */
@WebServlet(name = "StudentRegisterAction", urlPatterns = {"/studentRegisterAction"})
public class StudentRegisterAction extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("courseList", ActionUtils.getCourse(request));        
        ActionUtils.sendRequest(request, response, "studentRegister.jsp");
    }
