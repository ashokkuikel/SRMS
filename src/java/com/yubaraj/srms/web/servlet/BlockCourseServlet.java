 ...
 */
@WebServlet(name = "BlockCourseServlet", urlPatterns = {"/blockCourseServlet"})
public class BlockCourseServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (status.equals(SRMSConstant.ACTIVE_STATUS)) {
            course.setStatus(SRMSConstant.DEACTIVE_STATUS);
        } else {
            course.setStatus(SRMSConstant.ACTIVE_STATUS);
        }
        boolean modified = manager.modifyCourse(course);
       ActionUtils.viewCourse(request, response);
    }
