...
public class SubjectRegisterServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         ...
         subjectDto.setCourseName(request.getParameter("course"));
         subjectDto.setSubjectName(request.getParameter("subjectName"));
         subjectDto.setFullMarks(new Double(request.getParameter("fullMarks")));
         subjectDto.setPassMarks(new Double(request.getParameter("passMarks")));
         
         Manager manager = new DatabaseManager(applicationUser);
        Subject subject = manager.registerStudent(subjectDto);
        if (subject == null) {
        ...
        String page = "subjectRegister.jsp";
