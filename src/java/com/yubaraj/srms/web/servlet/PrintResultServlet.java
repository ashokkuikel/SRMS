...
import com.yubaraj.srms.web.utilities.ResultPrinter;
 ...
 */
@WebServlet(name = "PrintResultServlet", urlPatterns = {"/printResultServlet"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (rollString != null) {
            ...
            if (isPassed(resultList)) {
                result = SRMSConstant.PASSED + " !";
            } else {
                result = SRMSConstant.FAILLED + " !";
            }
            File file = ResultPrinter.print(studentName, course, rollString, resultList, totalObtainedMarks.toString(), calculatePercent(totalFullMarks, totalObtainedMarks), result);
