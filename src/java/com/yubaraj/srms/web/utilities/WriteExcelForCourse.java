...
//
//import com.yubaraj.sms.DTO.CourseDTO;
//import java.io.File;
...
// */
//public class WriteExcelForCourse {
//
...
//
//    public WriteExcelForCourse(String column[], List<CourseDTO> reportList, Logger logger) {
//        this.logger = logger;
//        try {
...
//    }
//
//    private void write(String[] column, List<CourseDTO> reportLst, Logger logger) throws IOException, WriteException {
//        try {
//            File file = inputFile;
...
//    }
//
//    private void createLabel(WritableSheet sheet, String[] column, List<CourseDTO> reportList, Logger logger)
...
//                    switch (j) {
//                        case 0:
//                            addLabel(sheet, j, i + 1, reportList.get(i).getCourseId().toString());
//                            break;
//                        case 1:
//                            addLabel(sheet, j, i + 1, reportList.get(i).getCourseName());
//                            break;
//                        case 2:
//                            addLabel(sheet, j, i + 1, reportList.get(i).getCourseDescription());
//                            break;
//                        case 3:
...
//                            break;
//                        case 6:
//                            addLabel(sheet, j, i + 1, reportList.get(i).getModifiedBy());
//                            break;
//                        case 7:
//                            addLabel(sheet, j, i + 1, reportList.get(i).getModifiedDate());
//                            break;
//                    }
//                }
//            }
